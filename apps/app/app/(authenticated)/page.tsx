...
// ─── Placeholder data ──────────────────────────────────────────────────────
const recentLeave = [
  { name: "Priya Sharma", type: "Annual Leave", from: "Apr 7", to: "Apr 11", status: "approved" },
  { name: "Marcus Webb", type: "Sick Leave", from: "Apr 5", to: "Apr 6", status: "approved" },
  { name: "Yuki Tanaka", type: "Annual Leave", from: "Apr 14", to: "Apr 18", status: "pending" },
  { name: "Aisha Okonkwo", type: "Parental Leave", from: "Apr 22", to: "Jun 30", status: "approved" },
  { name: "Tom Eriksson", type: "Annual Leave", from: "Apr 28", to: "May 2", status: "pending" },
];

const upcoming = [
  { name: "Yuki Tanaka", days: "Mon 14 – Fri 18 Apr", type: "Annual Leave" },
  { name: "Aisha Okonkwo", days: "Tue 22 Apr – Mon 30 Jun", type: "Parental Leave" },
  { name: "Tom Eriksson", days: "Mon 28 Apr – Fri 2 May", type: "Annual Leave" },
];
      ...
      <div className="grid gap-5 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-5 rounded-2xl bg-muted p-6">
          <div className="flex items-center justify-between">
            ...
            <ClockIcon className="size-4 text-muted-foreground" strokeWidth={1.75} />
          </div>
              ...
              >
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-[0.875rem] font-medium text-foreground leading-tight">
                      {entry.name}
                    </p>
        ...
        <div className="flex flex-col gap-5 rounded-2xl bg-muted p-6">
          <div className="flex items-center justify-between">
            ...
            <TrendingUpIcon className="size-4 text-muted-foreground" strokeWidth={1.75} />
          </div>
          ...
          <div className="flex flex-col gap-3">
            {upcoming.map((entry, i) => (
              ...
              >
                <div
                  className="flex size-8 shrink-0 items-center justify-center rounded-lg text-[0.75rem] font-semibold"
                  style={{
                ...
                <div className="min-w-0">
                  ...
                  <p
                    className="mt-1 inline-block rounded-md px-2 py-0.5 text-[0.6875rem] font-medium"
                    style={{
...
const StatCard = ({ icon, label, value, sub, trend, trendUp }: StatCardProps) => (
  <div className="flex flex-col gap-4 rounded-2xl bg-muted p-6">
    ...
    <div>
      <p className="text-[2.75rem] font-semibold leading-none tracking-tight text-foreground">
        {value}
      </p>
