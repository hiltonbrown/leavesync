...
| [027](027-validate-the-clerk-user-before-binding-it-to-a-person.md) | A Person can bind only to a valid Clerk member of the active organisation | TODO — reconciled 2026-08-08 at `b0fa224`, cosmetic drift only (`where`/`include` reorder), finding confirmed. Depends on 050 (`050 -> 027`). |
